...
def bundle_to_display_dict(bundle: ExportBundle, unit_preset: UnitPreset) -> dict[str, Any]:
    ...
    return {
        ...
        "inputs": {
            ...
            "bell_length_fraction_percent": bundle.inputs.bell_length_fraction_percent,
...
def _summary_rows(bundle: ExportBundle) -> list[tuple[str, str, float | None, str | None]]:
    return [
        ...
        ("inputs", "bell_length_fraction_percent", bundle.inputs.bell_length_fraction_percent, None),
